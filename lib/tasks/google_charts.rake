...
namespace :googlecharts do
  ...
  task :jspdf do
    say "grabbing jspdf codebase..." do
      sh "curl -# http://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.5/jspdf.min.js -L --compressed -o lib/daru/view/adapters/js/googlecharts_js/jspdf.min.js"
    end
  end
